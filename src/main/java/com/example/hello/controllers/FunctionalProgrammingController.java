...
public class FunctionalProgrammingController extends BasicProgrammingController {

    public FunctionalProgrammingController(@Qualifier("functionalProgrammingService") ExampleProgrammingService programmingService,
